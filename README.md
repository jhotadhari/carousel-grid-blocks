WordPress Plugin Carousel Grid Blocks

Two Gutenberg image blocks that interact with each other and share the same state.

> Plugin readme: [./dist/trunk/README.md](https://github.com/jhotadhari/carousel-grid-blocks/tree/master/dist/trunk)
...
To install it from zip file, [download latest release](https://github.com/jhotadhari/carousel-grid-blocks/releases/latest).
...
* [Create a new issue on Github](https://github.com/jhotadhari/carousel-grid-blocks/issues/new)
* ~~[Add a new topic to WP's support forum](https://wordpress.org/support/plugin/carousel-grid-blocks)~~
* ~~[Create a new review and rate this Plugin](https://wordpress.org/support/plugin/carousel-grid-blocks/reviews/#new-post)~~
